...
const juanBooks: Book[] = [
  {
    ...
    description: {
      es: "Cinco hombres suben a una montaña a hablar de lo que se hizo en sus nombres. No son ellos quienes hablarán.\n\nJesús llega a la cima del Roraima descalzo, sus sandalias perdidas en el ascenso. Mahoma trae el último dátil de Medina en su mano cerrada. Buda, un cuenco de madera. Krishna, una flauta de bambú. Quetzalcóatl, el silencio de un pueblo que sus seguidores no pudieron salvar de la cruz.\n\nDurante cuatro días se sientan en la cumbre, intercambiando los nombres que no han pronunciado en dos mil años. Luego descienden juntos a una aldea que no aparece en ningún mapa, donde una curandera llamada Ixchel ha mantenido vivos a los enfermos mientras ellos predicaban. Ella no quiere sus sermones. Quiere sus manos.\n\nUna a una, mientras los hombres cavan pozos, limpian heridas y reparan techos, las mujeres suben por el camino: María, Khadija, Mahapajapati y Radha. No vienen a perdonar. Vienen a ser escuchadas, luego respondidas, y luego a poner a los hombres a trabajar junto a ellas.\n\nUna novela silenciosa y demoledora sobre cinco fundadores de las grandes religiones y las mujeres que dejaron atrás, borraron o permitieron que fueran borradas. Escrita desde una perspectiva puertorriqueña y caribeña, en el linaje de José Saramago, J.M. Coetzee y Toni Morrison.",
